<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Road Map</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt bx-color"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">List Road Map</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3" action="<?=base_url();?>auth/is_session/about/" method="GET"
                        ...
                        <?php echo form_close(); ?>
                    <div class="ms-auto"><a href="<?=base_url()?>auth/is_session/about/add/"
                ...
                <div class="table-responsive">
                  ...
                  ?> <tr>
                                    ...
                                    <td>
                                       <form method="post"
                                           action="<?=site_url('/auth/is_session/about/showpay');?>">
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="<?=base_url()?>auth/is_session/about/edit?jwt_token=<?php echo encrypt_decrypt($row->id, 'encrypt')?>"
...
<script>
  ...
  function validate(id, category) {
    swal({
      ...
      $(location).attr('href', '<?php echo base_url()?>auth/is_session/about/delete/' +id);
    });
  }
</script>