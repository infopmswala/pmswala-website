            ...
            <div class="col-md-6 h-100 m-auto order1">
                ...
                <div class="container">
                    <h3 class="text-green">Discover an exciting method of investing</h3>
                     <?php echo form_open("login/save/", array("id" => "form-login", "class" => "form-horizontal")) ?>
                        ...
                        <div class="mt-5">
                            ...
                            <div class="input-group input-group-sm">
                                ...
                                <input type="tel" name="phone" id="phonenumber"  placeholder="Enter Phone Number" class="form-control border" required>
                            </div>
                            <!--<input type="test" name="phone" id="phone" autocomplete="off" class="input">
                            <label class="user-label"><img width="20" height="20" src="https://img.icons8.com/metro/20/phone.png" alt="phone"/> Enter Mobile Number</label>-->
