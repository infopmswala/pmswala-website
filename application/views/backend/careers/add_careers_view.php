            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add Careers</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">Add Jobs</h5>
                        </div>
                        <hr>
                        <form class="row g-3" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" rows="10" id="editor" cols="80" name="job_type"></textarea>
                            </div>
                            <!-- <div class="col-md-12">
                                <label for="inputFirstName" class="form-label">Featured Image</label>
                                <input type="file" class="form-control" name="job_image" required>
                            </div> -->
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <button type="submit" name="submit" value="td_careers" class="btn btn-primary px-5">Submit</button>
