    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3" action="<?=base_url();?>auth/is_session/product/" method="GET"
                        ...
                        <?php echo form_close(); ?>
                    <div class="ms-auto"><a href="<?=base_url()?>auth/is_session/product/add/"
                ...
                <div class="table-responsive">
                  ...
                  ?> <tr>
                                    ...
                                    <td>
                                       <form method="post"
                                           action="<?=site_url('/auth/is_session/product/showpay');?>">
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="<?=base_url()?>auth/is_session/product/edit?jwt_token=<?php echo encrypt_decrypt($row->id, 'encrypt')?>"
...
<script>
  ...
  function validate(id, category) {
    swal({
      ...
      $(location).attr('href', '<?php echo base_url()?>auth/is_session/product/delete/' +id);
    });
  }
</script>