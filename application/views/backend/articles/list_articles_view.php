        ...
        <div class="card">
            <div class="card-body">
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    <form class="row g-3" action="<?=base_url();?>auth/is_session/articles/list_articles/" method="GET"
                        ...
                        <?php echo form_close(); ?>
                        <div class="ms-auto"><a href="<?=base_url()?>auth/is_session/articles/add_articles/"
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="tablelist">
                        ...
                        <tbody>
                            ...
                            <?php 
                            if(!empty($td_articles)){
                  foreach(array_reverse($td_articles) as $key =>$row)
                  {
                  ?><tr id="sortable">
                                <td>
                                ...
                                <td>
                                    <form method="post"
                                        action="<?=site_url('/auth/is_session/articles/list_articles/showpay');?>">
                                ...
                                <td>
                                    <div class="d-flex order-actions">
                                        <a href="<?=base_url()?>auth/is_session/articles/edit_articles/index?jwt_token=<?php echo encrypt_decrypt($row->id, 'encrypt')?>"
...
function validate(id, title) {
    swal({
        ...
        $(location).attr('href',
            '<?php echo base_url()?>auth/is_session/articles/list_articles/delete_articles/' + id);
    });
}
</script>