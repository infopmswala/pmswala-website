        ...
        <div class="card">
            <div class="card-body">
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    <form class="row g-3" action="<?=base_url();?>auth/is_session/testimonial/testimonial_list/<?=$td_modules['module_id']?>/" method="GET"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="q"
                                ...
                                placeholder="Search Testimonials Name" id="inputFirstName">
                        </div>
                        <div class="col-md-3">
                            <label for="inputFirstName" class="form-label">&nbsp;&nbsp;</label>
                        ...
                        <div class="ms-auto"><a href="<?=base_url()?>auth/is_session/testimonial/add_testimonial/<?=$td_modules['module_id']?>/"
                ...
                <div class="table-responsive">
                    <table class="table mb-0">
                        ...
                        <tbody>
                            <tr>
                                <?php 
                                 if(!empty($td_testimonials)){
                                 foreach($td_testimonials as $key =>$row){ ?>
                                <td>
                                ...
                                <td>
                                    <form method="post"
                                        action="<?=site_url('/auth/is_session/testimonial/showpay');?>">
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="<?=base_url()?>auth/is_session/testimonial/edit_testimonial/<?=$td_modules['module_id']?>/?jwt_token=<?php echo encrypt_decrypt($row->id, 'encrypt')?>"
                                                class=""><i class="bx bxs-edit" style="font-size: 25px;color: #008000;"></i></a>
                                            <a href="javascript:;" class="ms-3" onclick="validate('<?php echo $row->id;?>','<?php echo $row->name;?>')"><i class="bx bxs-trash" style="font-size: 25px;color: #ef0716;"></i></a>
                                        </div>
                                    </td>
                            </tr>
                            <?php
...
function validate(id, title) {
    swal({
        ...
        $(location).attr('href',
            '<?php echo base_url()?>auth/is_session/testimonial/delete_testimonials/' + id);
    });
}
</script>
