    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3" action="<?=base_url();?>auth/is_session/job/list_job/" method="GET"
                        ...
                        <?php echo form_close(); ?>
                    <div class="ms-auto"><a href="<?=base_url()?>auth/is_session/job/add_job/"
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="tablelist">
                        ...
                        <tbody>
                            ...
                            <?php 
                            if(!empty($td_job)){
                  foreach(array_reverse($td_job) as $key =>$row)
                  {
                  ?><tr id="sortable">
                                <td>
                                ...
                                <td>
                                    <form method="post"
                                        action="<?=site_url('/auth/is_session/job/list_job/showpay');?>">
                                ...
                                <td>
                                    <div class="d-flex order-actions">
                                        <a href="<?=base_url()?>auth/is_session/job/edit_job/index?jwt_token=<?php echo encrypt_decrypt($row->id, 'encrypt')?>"
                                            class=""><i class='bx bxs-edit'></i></a>
                                        <a href="#" onclick="validate('<?php echo $row->id;?>','<?php echo $row->question;?>')" class="ms-3"><i class='bx bxs-trash'></i></a>
                                    </div>
                                </td>
                            </tr>
                            <?php
...
<script>
  ...
  function validate(id, title) {
    swal({
      ...
      $(location).attr('href', '<?php echo base_url()?>auth/is_session/job/list_job/delete_job/' +id);
    });
  }
</script>