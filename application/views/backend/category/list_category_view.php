        ...
        <div class="card">
            <div class="card-body">
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    <form class="row g-3" action="<?=base_url();?>auth/is_session/category/list_category/" method="GET"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="q"
                                ...
                                placeholder="Search Category Name" id="inputFirstName">
                        </div>
                        <div class="col-md-3">
                            <label for="inputFirstName" class="form-label">&nbsp;&nbsp;</label>
                        ...
                        <div class="ms-auto"><a href="<?=base_url()?>auth/is_session/category/add_category/"
                    ...
                    <table class="table mb-0">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <form method="post"
                                        action="<?=site_url('/auth/is_session/category/list_category/category_showpay');?>">
                                        <input type="hidden" name="category_id" value="<?=$row->id;?>">
                                        <input onChange="this.form.submit()" type="checkbox" name="feature_id"
                                            id="status_a<?=$row->category_id;?>" class="check"
                                            value="<?php if($row->top_category==0){echo '1';}else{echo '0';}?>"
                                            <?php if($row->top_category==1)echo 'checked';?>>
                                        <label for="status_a<?=$row->category_id;?>"
                                            class="checktoggle">checkbox</label>
                                    </form>
                                </td>
                                <td>
                                    <form method="post"
                                        action="<?=site_url('/auth/is_session/category/list_category/menu_showpay');?>">
                                ...
                                <td>
                                    <div class="d-flex order-actions">
                                        <a href="<?=base_url()?>auth/is_session/category/edit_category/index?jwt_token=<?php echo encrypt_decrypt($row->id, 'encrypt')?>"
                                            class=""><i class='bx bxs-edit'
                                                style="font-size: 25px;color: #008000;"></i></a>
                                        <a href="#"
                                            onclick="validate('<?php echo $row->id;?>','<?php echo $row->category;?>')"
...
function validate(id, title) {
    swal({
        ...
        $(location).attr('href',
            '<?php echo base_url()?>auth/is_session/category/list_category/delete_category/' + id);
    });
}
</script>