                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="p-4 rounded">
                                    ...
                                    <div class="form-body">
                                        <form class="row g-3" action="<?=base_url()?>auth/log_session/forgot_password/" method="post">
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <div class="d-grid">
                                                    <button type="submit" class="btn btn-primary" style="background-color: <?=get_color_code();?> !important; border-color: <?=get_color_code();?> !important;"><i
                                                            class="bx bxs-lock-open"></i>Submit</button>
                                                </div>
                                            </div>
                                        </form><br>
                                        <div class="col-md-6 text-end"> <a
                                                    href="<?=base_url()?>auth/log_session/login/" style="color: <?=get_color_code();?> !important;">Back To Login</a>
                                            </div>
                                    </div>
                                </div>
                            </div>
