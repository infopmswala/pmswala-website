                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">Add Articles</h5>
                        </div>
                        <hr>
                        <form class="row g-3" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="file" class="form-control" name="articles_image" required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <button type="submit" name="submit" value="td_articles" class="btn btn-primary px-5">Submit</button>
