    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">List Withdrawal Request</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3" action="<?=base_url();?>auth/is_session/users_info/user_withdrawal_request/" method="GET"
                    ...
                    <table class="table table-bordered table-striped" id="tablelist">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th>Withdrawal Request Approved</th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                            if(!empty($td_withdrawal_request)){
                  foreach($td_withdrawal_request as $key =>$row)
                  {
                  ?><tr id="sortable">
                                <td>
                                ...
                                <td><?= $row->name?> </td>
                                <td>#<?= $row->withdrawal_request_id?> </td>
                                ...
                                <td>
                                    ...
                                    <?php }else{ ?>
                                        <p style="color: green;font-size: 15px;">Payment Request Approved Successfully</p>
                                   <?php } ?>
                                </td>
                                  ...
                                  <div class="modal-dialog">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        <form class="row g-3" action="<?=base_url()?>auth/is_session/users_info/withdrawal_request_payment_status/" method="post" enctype="multipart/form-data">
                                          <div class="mb-3">
...
<script>
    function ExportData(){
        window.location.href='<?=base_url()?>auth/is_session/users_info/user_withdrawal_request_info_history_download/?show='+$("[name=show]").val()+'&q='+$("[name=q]").val()+'&Fdate='+$("[name=Fdate]").val()+'&Tdate='+$("[name=Tdate]").val()+'';
    }
</script>