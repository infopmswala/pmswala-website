...
class Edit_category extends My_Controller {
...
// 					$this->session->set_flashdata("error", '<p style="color:red">category ' . $error['error'] . ' for Logo</p>');
// 					redirect(base_url() . "auth/is_session/category/edit_category/index?jwt_token=".$get_id);
// 				  } else {
...
// 			}
                $where = array("id" => $id);
			    $this->Main_model->update_data($where, $data, "td_category");
        ...
        $this->data['_view_'] = 'backend/category/edit_category_view';
