                ...
                <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
                    <div class="col mx-auto">
                        <div class="mb-4 text-center">
                            <img src="<?=base_url()?>assets/backend/images/logo-img.png" width="180" alt="" />
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <div class="p-4 rounded">
                                    <div class="text-center">
                                        ...
                                        <a href="<?=base_url()?>auth/log_session/login/">
                                        <img src="<?=base_url()?>assets/backend/images/logo.png" alt="<?=get_compnay_title()?>">
                                        </a>
                                    ...
                                    <div class="form-body">
                                        <form class="row g-3" action="<?=base_url()?>auth/log_session/login/" id="myform" method="post">
                                            <div class="col-12">
                                                <label for="inputEmailAddress" class="form-label">Email Address</label>
                                                <input type="email" class="form-control" id="inputEmailAddress"
                                                    placeholder="Email Address" name="email" data-parsley-required="true" required="" data-parsley-required-message="Enter Email Id / Mobile No">
                                            </div>
                                            <div class="col-12">
                                                ...
                                                <div class="input-group" id="show_hide_password">
                                                    <input type="password"  name="password" class="form-control border-end-0"
                                                        id="inputChoosePassword" placeholder="Enter Password" data-parsley-required="true" required="" data-parsley-required-message="Enter password"> <a
                                            ...
                                            <div class="col-md-6 text-end"> <a
                                                    href="<?=base_url()?>auth/log_session/forgot_password/" style="color: <?=get_color_code();?> !important;">Forgot
                                                    Password ?</a>
                                            </div>
                                            <div class="col-12">
                                                <div class="d-grid">
                                                    <button  type="submit" class="btn btn-primary" style="background: <?=get_color_code();?> !important;border-color: <?=get_color_code();?> !important;"><i
