<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">SEO Pagesk</div>
            <div class="ps-3">
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">Edit SEO Page</h5>
                        </div>
                        <hr>
                        <form id="myform" method="post" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="page_name" value="<?=$td_seo[0]->page_name?>"
                                        id="page_name" class="form-control" placeholder="Enter Page Name" required />
                                </div>
                                <div class="col-md-6">
                                    <label for="inputFirstName" class="form-label">Page Url</label>
                                    <input type="text" name="url" value="<?=$td_seo[0]->url?>" id="url"
                                        class="form-control" placeholder="Enter Page Url" required />
                                </div>
                                <div class="col-md-6">
                                    <label for="inputFirstName" class="form-label">Meta Title</label>
                                    <input type="text" name="meta_tag_title" value="<?=$td_seo[0]->meta_tag_title?>"
                                        id="meta_tag_title" class="form-control" placeholder="Enter Meta Title"
                                        required />
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <textarea type="text" name="meta_tag_keywords" id="meta_tag_keywords"
                                        ...
                                        required /><?=$td_seo[0]->meta_tag_description?></textarea>
                                </div>
                                <div class="col-md-6">
                                    ...
                                    <textarea type="text" name="meta_tag_description" id="meta_tag_description"
                                        ...
                                        required /><?=$td_seo[0]->meta_tag_keywords?></textarea>
                                </div>
                            </div>
                            </br>
                            <div class="row">
                                <div class="form-group">
                                    <button type="submit" name="update" value="add_seo"
