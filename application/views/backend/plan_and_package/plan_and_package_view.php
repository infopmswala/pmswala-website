            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add Plan & Package</li>
                    </ol>
                </nav>
            </div>
        </div>
                    ...
                    <div class="card-body p-5">
                        ...
                        <form class="row g-3" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="plan_and_package_name" >
                            </div>
                            <div class="col-md-12">
                                <label for="inputFirstName" class="form-label">Plan & Package Pricing</label>
                                <input type="text" class="form-control" name="plan_and_package_pricing" >
                            </div>
                            <div class="col-md-6" style="">
                            <a type="button" name="add" id="add" title="Delete" class="text-red delete-field bx-color">
                            <i class="lni lni-plus btn btn-primary" style="border-radius: 25px;background: #73AD21;padding: 12px;"></i></a>
                            </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    <form class="row g-3" action="<?=base_url();?>auth/is_session/portfolio/" method="GET"
...
function validate(id, title) {
    swal({
        ...
        $(location).attr('href', '<?php echo base_url()?>auth/is_session/plan_and_package/delete_price_list/' +
            id);
    });
}
</script>
<script>
 $(document).ready(function(){
   ...
   $("#add").click(function(){
    i++;
    $('#dynamic_field').append('<div id="row'+i+'" class="row g-3"><div class="col-md-10"><label for="inputFirstName" class="form-label">Pricing Item</label><input type="text" class="form-control" name="pricing_item[]" required></div><div class="col-md-2"><button type="button" name="remove" id="'+i+'" class="btn btn-danger btn_remove" style="border-radius: 45px;background: #e62e2e;">X</button></div></div>');  
     });
