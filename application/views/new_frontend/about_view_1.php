			...
			<div class="container">
			    ...
			    <div class="row mb-5">
			        <div class="col-12 text-center">
			            <h1 class="section-title">About PMS Wala: Expertise, Integrity, and Excellence in Portfolio Management</h1>
			            <h4 class="section-subtitle">Greetings from PMS Wala, your go-to source for portfolio management services.</h4>
			        </div>
			    </div>
			    ...
			    <div class="row align-items-center g-4 mb-5">
			        ...
			        <div class="col-12 col-lg-5 order-2 order-lg-1">
			            <div class="about-image-wrapper">
                            <img src="<?=base_url()?><?=$val['image'];?>" alt="About PMS Wala" class="img-fluid">
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-lg-7 order-1 order-lg-2">
                        <div class="about-content-card">
                            <div class="about-text">
                                <span class="highlight">Established in May 2022,</span> 
                            ...
                            <div class="team-section">
                                <h4><i class="bi bi-people-fill"></i> Meet Our Team</h4>
                                <p>This is a team of sharp and experienced investment professionals who bring a pool of knowledge and skills to the table. We work interactively with you in offering customized investment strategies that are in line with your financial goals.</p>
                            </div>
                        </div>
                    </div>
			    </div>
			    ...
			    <div class="row">
			        <div class="col-12">
			            <div class="core-values-section">
			                <h2 class="text-center mb-4" style="color: #198754; font-weight: 700;">Our Core Values</h2>
			                ...
			                <div class="row">
			                    <div class="col-12 col-md-6 col-lg-4 mb-3">
			                        <div class="core-value-item">
			                            ...
			                            <div class="core-value-content">
			                                <h5>Integrity</h5>
			                                <p>In all our dealings, we uphold the best ethical standards to ensure that everything is open and trustworthy.</p>
			                            </div>
			                        </div>
			                    </div>
			                    ...
			                    <div class="col-12 col-md-6 col-lg-4 mb-3">
			                        <div class="core-value-item">
			                            ...
			                            <div class="core-value-content">
			                                <h5>Excellence</h5>
			                                <p>Excellence is the hallmark of every company's offering, either in terms of the firm's investment strategy or clients' service.</p>
			                            </div>
			                        </div>
			                    </div>
			                    ...
			                    <div class="col-12 col-md-6 col-lg-4 mb-3">
			                        <div class="core-value-item">
			                            ...
			                            <div class="core-value-content">
			                                ...
			                                <p>Your financial goals are our priority. We focus on delivering solutions that are individual per your needs.</p>
			                            </div>
			                        </div>
			                    </div>
			                </div>
			                ...
			                <div class="text-center mt-4">
			                    <p class="about-text" style="max-width: 900px; margin: 0 auto;">
