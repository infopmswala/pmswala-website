            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add Var Section</li>
                    </ol>
                </nav>
            </div>
        </div>
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">Add Var Section</h5>
                        </div>
                        <hr>
                        <form id="myform" method="post" method="post" enctype="multipart/form-data">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" value="" name="sub_title" id="sub_title"
                                        class="form-control"  />
                                </div>
                                 <div class="col-md-12">
