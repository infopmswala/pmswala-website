<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Edit Journey</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt bx-color"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Edit Journey</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">Edit Journey</h5>
                        </div>
                        <hr>
                        <form id="myform" method="post" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" value="<?=$tbl_journey[0]->title?>"
                                        name="title" id="title" class="form-control" required />
                                </div>
                                 <div class="col-md-6">
                                    <label for="inputFirstName" class="form-label"> Description</label>
                                    <!--<input type="text" value="<?=$tbl_why_pmswala[0]->description?>"-->
                                    <!--    name="short_description" id="short_description" class="form-control" />-->
                                    <input type="text" value="<?=$tbl_journey[0]->description?>"
                                        name="short_description" id="short_description" class="form-control" />
                                </div>
                                  <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                                    ...
                                    <img src="<?=base_url()?><?=$tbl_journey[0]->image;?>" alt="Avatar" style="width:136px;border-radius: 50%;height: 83px;">
                                </div>
