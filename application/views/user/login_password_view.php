    ...
    <div class="container">
        ...
        <div class="row mt-3 g-3 m-auto">
            ...
            <div class="col-md-6 h-100 m-auto order1">
                ...
                <div class="container">
                    <h3 class="text-green">User Register</h3>
                    <div id="the-message"></div>
                    <?php echo form_open("login/reg_save/", array("id" => "form-reg_save", "class" => "form-horizontal")) ?>  
                    <div class="row mb-5">
                        <div class="col-12 col-md-6">
                            <div class="mt-5">
                                <label class="mb-3 form-label" for="phonenumber">Please enter your Full Name</label>
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text bg-white"><img width="24" height="24" src="https://img.icons8.com/ios-glyphs/24/group.png" class="me-2" alt="india"/></span>
                                    <input type="text" name="full_name" id="full_name"  placeholder="Please enter your Full Name" class="form-control border">
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="mt-5">
                                <label class="mb-3 form-label" for="phonenumber">Please enter your mobile number</label>
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text bg-white"><img width="24" height="24" src="https://img.icons8.com/color/24/india.png" class="me-2" alt="india"/> +91</span>
                                    <input type="tel" name="phone" id="phone"  placeholder="Enter Phone Number" class="form-control border">
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            <div class="mt-5">
                                <label class="mb-3 form-label" for="phonenumber">Please enter your New Password</label>
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text bg-white"><img width="24" height="24" src="https://img.icons8.com/ios-glyphs/30/key--v1.png" class="me-2" alt="india"/></span>
                                    <input type="password" name="password" id="password"  placeholder="Enter Password" class="form-control border">
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="mt-5">
                                <label class="mb-3 form-label" for="phonenumber">Please enter your Confirm Password</label>
                                <div class="input-group input-group-sm">
                                    <span class="input-group-text bg-white"><img width="24" height="24" src="https://img.icons8.com/ios-filled/50/portrait-orientation-lock.png" alt="portrait-orientation-lock" class="me-2" alt="india"/></span>
                                    <input type="password" name="conf_password" id="conf_password"  placeholder="Enter Password" class="form-control border">
                                </div>
                            </div>
                        </div>
                    </div>
                    <a href="<?=base_url()?>login/user_login/" class="fs-20 fw-semibold">Already a User? Login</a>
                    <div class="m-auto text-center mt-5">
                        <button type="submit"  class="btn btn-success m-auto text-center text-uppercase text-white rounded-2 ff-heading fw-bold shadow">Submit</button>
                    </div>
                    </form>
...
<link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/css/toastr.min.css">
  <script>
  $('#form-reg_save').submit(function(e) {
    e.preventDefault();
    var me = $(this);
    $.ajax({
      url: me.attr('action'),
      ...
      success: function(response) {
        if (response.success == true) {
            window.location.replace("<?=base_url()?>login/user_login/");
          $('#the-message').append('<div class="alert alert-success">' + '<span class="glyphicon glyphicon-ok"></span>' +
         'Thankyou for contacting us, our team will get in touch with you shortly'   +'</div>');
          $('.form-group').removeClass('has-error')
            .removeClass('has-success');
