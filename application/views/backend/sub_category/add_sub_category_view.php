            ...
            <div class="col">
              ...
              ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="sub_category" id="inputFirstName" required>
                            </div>
                            <div class="col-md-6">
                                <label for="inputFirstName" class="form-label">Sub Category Slug</label>
                                <input type="text" class="form-control" name="sub_category_slug" id="sub_category_slug" required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <!-- <div class="col-md-6">
                                <label for="inputFirstName" class="form-label">Sub Category Image</label>
                                <div class="upload-btn-wrapper">
                                    <input type="file" name="sub_category_image" id="fileUpload">
                                </div>
                            </div> -->
                            <div class="col-12">
                                <button type="submit" name="submit" value="sub_category" class="btn btn-primary px-5">Submit</button>
                            </div>
                        </form>
                    </div>
                </div>
