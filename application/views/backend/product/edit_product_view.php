                            ...
                            <div class="row">
                                <div class="col-md-6">
                                   <label for="inputFirstName" class="form-label"> Title</label>
                                    <input type="text" value="<?=$tbl_product[0]->title?>"
                                        name="title" id="title" class="form-control" required />
                                </div>
                                 <div class="col-md-6">
                                    <label for="inputFirstName" class="form-label">Short Description</label>
                                    <input type="text" value="<?=$tbl_product[0]->short_description?>"
                                        name="short_description" id="short_description" class="form-control" required />
                                </div>
                                  ...
                                  <div class="col-md-12">
                                    ...
                                    <textarea type="text" name="description" id="editor" class="form-control summernote"
                                        required /><?=$tbl_product[0]->description?></textarea>
                                </div>
                              ...
                              <div class="col-md-6">
                                    <label for="inputFirstName" class="form-label">Image</label>
                                    <img src="<?=base_url()?><?=$tbl_product[0]->image;?>" alt="Avatar" style="width:136px;border-radius: 50%;height: 83px;">
                                </div>
                                ...
                                <div class="form-group mt-5">
                                    ...
                                    <a onclick="window.location='<?=base_url()?>auth/is_session/product/';"
