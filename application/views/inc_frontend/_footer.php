<a href="https://api.whatsapp.com/send?phone=+918982529261 &amp; text=Welcome to PMSWala" class="float" target="_blank">
				...
				<div class="row g-3 mb-3">
					...
					<div class="col-xl-3 col-lg-6 col-md-6">
						<div class="footer-widget">
                            ...
                            <ul class="footer-list">
							    <li>
							        <a href="tel:+91 <?=$td_settings['phone'];?>"><i class="fa fa-phone"></i> +91 <?=$td_settings['phone'];?></a>
							     
							    </li>
							    <li>
							          <a href="mailto:<?=$td_settings['email'];?>"><i class="fa fa-envelope"></i> <?=$td_settings['email'];?></a>
							       
							    </li>
							    <li>
							        <a href=""><i class="fa fa-map-pin"></i> <?=$td_settings['address'];?></a>
							    </li>
							</ul>
							...
							<ul class="footer-list mt-3">
							    ...
							    <!-- <li>
							        <a href=""><i class="fa fa-map-pin"></i>Branch Address : <br>Plot No.6 Harisons House Malviya Nagar In Front of Mediline Hospital, Bhopal,  MP 462003</a>
							    </li> -->
							</ul>
						</div>
					</div>
			...
			<div class="ps-5 pe-5">
				<div class="copyright-element d-flex align-items-center">
					...
					<ul class="footer-social text-center mx-auto">
						...
						<li><a href="https://www.instagram.com/pmswala/" target=”_blank”><i class="bi bi-instagram"></i></a></li>
						<li><a href="https://x.com/PMSwala/" target=”_blank”><i class="fab fa-twitter"></i></a></li>
						<li><a href="https://www.facebook.com/profile.php?id=61559313074738" target=”_blank”><i class="fab fa-facebook"></i></a></li>
						<li><a href="https://www.linkedin.com/company/pms-wala/" target=”_blank”><i class="fab fa-linkedin"></i></a></li>
						<li><a href="https://play.google.com/store/apps/details?id=com.invest.pmswala&hl=en" target="_blank"><i class="fab fa-google-play"></i></a></li>
						<li><a href="https://apps.apple.com/in/app/pmswala/id6744605634" target="_blank"><i class="fab fa-apple"></i></a></li>
					</ul>
				</div>
			</div>
		</div>
