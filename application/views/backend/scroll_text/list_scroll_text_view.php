<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Scroll Text</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt bx-color"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">List Scroll Text</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3" action="<?=base_url();?>auth/is_session/scroll_text/list_scroll_text/" method="GET"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="q"
                                ...
                                placeholder="Search  Scroll Text" id="inputFirstName">
                        </div>
                        <div class="col-md-3">
                            <label for="inputFirstName" class="form-label">&nbsp;&nbsp;</label>
                        ...
                        <?php echo form_close(); ?>
                    <div class="ms-auto"><a href="<?=base_url()?>auth/is_session/scroll_text/add_scroll_text/"
                ...
                <div class="table-responsive">
                    <table class="table mb-0">
                        ...
                        <tbody>
                            <tr>
                                <?php 
                                if(!empty($td_scroll_text)){
                  foreach($td_scroll_text as $key =>$row)
                  {
                  ?>
                                <td>
                                ...
                                <td><?= $row->scroll_text?> </td>
                               
                                <td><?php echo Dateconversion($row->created_at); ?></td>
                                <td><?php echo Timeconversion($row->created_at); ?></td>
                                <td>
                                    <form method="post"
                                        action="<?=site_url('/auth/is_session/scroll_text/list_scroll_text/showpay');?>">
                                ...
                                <td>
                                    <div class="d-flex order-actions">
                                        <a href="<?=base_url()?>auth/is_session/scroll_text/edit_scroll_text/index?jwt_token=<?php echo encrypt_decrypt($row->id, 'encrypt')?>"
                                            class=""><i class='bx bxs-edit' style="font-size: 25px;color: #008000;"></i></a>
                                        <a href="#" onclick="validate('<?php echo $row->id;?>')" class="ms-3" style="font-size: 25px;color: #ef0716;"><i class='bx bxs-trash'></i></a>
                                    </div>
                                </td>
                            </tr>
                            <?php
              ...
              ?><?php }else{ ?>
                <td colspan="6" style="text-align: center;color: red;font-size: 19px;">No Record Found</td>
...
<script>
  ...
  function validate(id, title) {
    swal({
      ...
      $(location).attr('href', '<?php echo base_url()?>auth/is_session/scroll_text/list_scroll_text/delete_scroll_text/' +id);
    });
  }
</script>