                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">Edit videos</h5>
                        </div>
                        <hr>
                        <form class="row g-3" method="post" enctype="multipart/form-data">
                            <div class="col-md-12">
                                <label for="inputFirstName" class="form-label">Title Name</label>
                                <input type="text" class="form-control" name="question" value="<?=$td_videos[0]->question?>" required>
                            </div>
                            
                            <div class="col-md-12">
                                <label class="form-label">Description</label>
                                <textarea class="form-control" rows="10" id="editor" cols="80" name="answer"><?=$td_videos[0]->answer?></textarea>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <img src="<?=base_url()?><?=$td_videos[0]->video_image;?>" alt="Avatar" style="width:136px;border-radius: 50%;height: 83px;">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <label for="inputFirstName" class="form-label"> Meta Title </label>
                                <input type="text" class="form-control" name="meta_title" value="<?=$td_videos[0]->meta_title?>"  required>
                            </div>
                            <div class="col-md-6">
                                <label for="inputFirstName" class="form-label"> Meta Keywords </label>
                                <input type="text" class="form-control" name="meta_keywords" value="<?=$td_videos[0]->meta_keywords?>"  required>
                            </div>
                            <div class="col-md-12">
                                <label for="inputFirstName" class="form-label"> Meta Description</label>
                                <textarea class="form-control" rows="10"  cols="80" name="meta_description"><?=$td_videos[0]->meta_description?></textarea>
                            </div>
                            <div class="col-12">
                                <button type="submit" name="update" value="td_videos" class="btn btn-primary px-5">Update</button>
