    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3" action="<?=base_url();?>auth/is_session/pages/certificate" method="GET"
                        ...
                        <?php echo form_close(); ?>
                    <div class="ms-auto"><a href="<?=base_url()?>auth/is_session/pages/add_certificate/"
                ...
                <div class="table-responsive">
                  ...
                  foreach($tbl_certificate as $key =>$row)
                  {
                  ?> <tr>
                                    <td><?= $start; ?></td>
                                    <td><?= $row->title?> </td>
                                    ...
                                    <td>
                                       <form method="post"
                                           action="<?=site_url('/auth/is_session/pages/showpay_certificate');?>">
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="<?=base_url()?>auth/is_session/pages/edit_certificate?jwt_token=<?php echo encrypt_decrypt($row->id, 'encrypt')?>"
