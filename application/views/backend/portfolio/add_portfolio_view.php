            ...
            <div class="col">
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        ...
                        <hr>
                        <form class="row g-3" action="<?=base_url()?>auth/is_session/portfolio/portfolio_add/<?=$this->uri->segment(5)?>/" method="post" enctype="multipart/form-data">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="title_2" required id="limitedTextarea" maxlength="50">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="upload-btn-wrapper">
                                    <input type="file" name="portfolio_image" id="fileUpload" required>
                                </div>
                            </div>
                            <!--<div class="col-md-6">-->
                            ...
                            <!--    <option value="Monthly">6 Monthly</option>-->
                            ...
                            <!--    <input type="number" class="form-control" name="monthly_interest" value=""  required>-->
                            <!--</div>-->
                            <div class="col-md-6">
                                <label for="inputFirstName" class="form-label"> Investment Category Details</label>
                                <input type="text" class="form-control" name="retune_value" required id="limited_Textarea" maxlength="50">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="payout_year" value="1" readonly>
                            </div>
                             <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <button type="submit" name="submit" value="portfolio_add"
