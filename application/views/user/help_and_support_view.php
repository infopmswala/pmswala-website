                    ...
                    <div class="inner-contents">
                        <div class="row">
                            <div class="col-12 col-md-9 m-auto">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="text-center m-auto justify-content-center">
                                            <h4 class="text-center bg-lightgreen p-3">Help & Support</h4>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mt-5 page-header align-items-center mr-bottom-30">
                                    <div class="text-center m-auto  mt-5">
                                        <h4 class="text-center bg-lightgreen p-3">List of Help & Support</h4>
                                    </div>
                                </div>
                            </div>
                        </div>
