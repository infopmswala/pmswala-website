    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">List Information</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3" action="<?=base_url();?>auth/is_session/information/list_information/" method="GET"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="q"
                                ...
                                placeholder="Search Page Name" id="inputFirstName">
                        </div>
                        <div class="col-md-3">
                            <label for="inputFirstName" class="form-label">&nbsp;&nbsp;</label>
                        ...
                        <?php echo form_close(); ?>
                    <div class="ms-auto"><a href="<?=base_url()?>auth/is_session/information/add_information/"
                ...
                <div class="table-responsive">
                    <table class="table mb-0">
                      ...
                      <tbody>
                                ...
                                <?php 
                                if(!empty($td_information)){
                  foreach($td_information as $key =>$row)
                  {
                  ?> <tr>
                                    <td><?= $start; ?></td>
                                    <td><?= $row->information_title?> </td>
                                   
                                  
                                    <td><?php echo Dateconversion($row->created_at); ?></td>
                                    <td>
                                       <form method="post"
                                           action="<?=site_url('/auth/is_session/information/list_information/showpay');?>">
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="<?=base_url()?>auth/is_session/information/edit_information/index?jwt_token=<?php echo encrypt_decrypt($row->id, 'encrypt')?>"
                                                class=""><i class='bx bxs-edit' style="font-size: 25px;color: #008000;"></i></a>
                                            <!--<a href="javascript:;" class="ms-3" onclick="validate('<?php echo $row->id;?>','<?php echo $row->information_title;?>')"><i class='bx bxs-trash' style="font-size: 25px;color: #ef0716;"></i></a>-->
                                        </div>
                                    </td>
                                </tr>
                                <?php
              ...
              ?><?php }else{ ?>
                <td colspan="5" style="text-align: center;color: red;font-size: 19px;">No Record Found</td>
...
<script>
  ...
  function validate(id, category) {
    swal({
      title: "Are you sure?",
      text: "Are you sure you want to delete this record" + " " + category,
      type: "warning",
      ...
      $(location).attr('href', '<?php echo base_url()?>auth/is_session/information/list_information/delete_information/' +id);
    });
  }
</script>