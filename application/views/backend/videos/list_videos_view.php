            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">List videos</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-lg-flex align-items-center mb-4 gap-3">
                    <form class="row g-3" action="<?=base_url();?>auth/is_session/videos/list_videos/" method="GET"
                        ...
                        <?php echo form_close(); ?>
                        <div class="ms-auto"><a href="<?=base_url()?>auth/is_session/videos/add_videos/"
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="tablelist">
                        ...
                        <tbody>
                            ...
                            <?php 
                            if(!empty($td_videos)){
                  foreach(array_reverse($td_videos) as $key =>$row)
                  {
                  ?><tr id="sortable">
                                <td>
                                ...
                                <td>
                                    <form method="post"
                                        action="<?=site_url('/auth/is_session/videos/list_videos/showpay');?>">
                                ...
                                <td>
                                    <div class="d-flex order-actions">
                                        <a href="<?=base_url()?>auth/is_session/videos/edit_videos/index?jwt_token=<?php echo encrypt_decrypt($row->id, 'encrypt')?>"
                                            class=""><i class='bx bxs-edit'></i></a>
                                        <a href="#"
                                            onclick="validate('<?php echo $row->id;?>','<?php echo $row->question;?>')"
...
function validate(id, title) {
    swal({
        ...
        $(location).attr('href', '<?php echo base_url()?>auth/is_session/videos/list_videos/delete_videos/' +
            id);
    });
}
</script>