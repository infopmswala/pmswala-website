                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        ...
                        <form class="row g-3" method="post" enctype="multipart/form-data">
                            ...
                            <?php  $get_id = $_GET['portfolio_id'] ?? '';
                            	$new_id = encrypt_decrypt($get_id, 'decrypt');
                            	?>
                            <input type="hidden" class="form-control" name="menu_id" value="<?=$new_id;?>">
                            <?php 
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="file" class="form-control" name="faq_image" required>
                            </div>
                            ...
                            <?php } ?>
                            <div class="col-12">
                                <button type="submit" name="submit" value="td_faqs" class="btn btn-primary px-5">Submit</button>
