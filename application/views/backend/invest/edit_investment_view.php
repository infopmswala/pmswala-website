                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">Edit Investment</h5>
                        </div>
                        <hr>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                   <label for="inputFirstName" class="form-label"> Title</label>
                                    <input type="text" value="<?=$tbl_investment[0]->title?>"
                                  ...
                                  <div class="col-md-6">
                                    ...
                                    <textarea type="text" name="short_description" id="editor" class="form-control summernote"
                                        required /><?=$tbl_investment[0]->short_description?></textarea>
                                </div>
                              ...
                              <div class="col-md-6">
                                    <label for="inputFirstName" class="form-label">Image</label>
                                    <img src="<?=base_url()?><?=$tbl_investment[0]->image;?>" alt="Avatar" style="width:136px;border-radius: 50%;height: 83px;">
                                </div>
                                ...
                                <div class="form-group mt-5">
                                    ...
                                    <a onclick="window.location='<?=base_url()?>auth/is_session/investment/';"
