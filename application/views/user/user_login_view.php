    ...
    <div class="container">
        ...
        <div class="row mt-3 g-3 m-auto">
            ...
            <div class="col-md-6 h-100 m-auto order1">
                ...
                <div class="container">
                    <h3 class="text-green">User Login</h3>
                    <div id="the-message"></div>
                    <?php echo form_open("login/user_login/", array("id" => "", "class" => "form-horizontal")) ?>  
                    <div class="row mb-5">
                        <div class="col-12 col-md-6">
                            <div class="mt-5">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="text" name="phone" id="phone"  placeholder="Enter Phone Number" class="form-control border" required>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="mt-5">
                                ...
                                <div class="input-group input-group-sm">
                                    ...
                                    <input type="password" name="password" id="password"  placeholder="Enter Password" class="form-control border" required>
                                </div>
                            </div>
                        </div>
                    </div>
                
                    <a href="<?=base_url()?>login/login_password/" class="fs-20 fw-semibold">New User? Register</a>
                    <div class="m-auto text-center mt-5">
                        <button type="submit"  class="btn btn-success m-auto text-center text-uppercase text-white rounded-2 ff-heading fw-bold shadow">Login</button>
                    </div>
                    </form>
