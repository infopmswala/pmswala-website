$(function () {
	...
	Highcharts.chart('chart1', {
		...
		subtitle: {
			text: 'Ratio of Innoplus Services'
		},
		tooltip: {
	...
	Highcharts.chart('chart2', {
		...
		subtitle: {
			text: 'Records of Products usage by Clients'
		},
		accessibility: {
			announceNewData: {
				enabled: true
		...
		yAxis: {
			title: {
				text: 'Products usage by Clients'
			}
		},
		legend: {
			enabled: false
		...
		series: [{
			...
			data: [{
				...
				name: "Dashboard Plus",
				y: 24.25,
				drilldown: "Dashboard Plus"
			}, {
				name: "Ecommerce Plus",
				y: 41.48,
				drilldown: "Ecommerce Plus"
			}, {
				name: "School Management",
				y: 44.32,
				drilldown: "School Management"
			}, {
				name: "Institute Management",
				y: 76.39,
				drilldown: "Institute Management"
			}, {
				name: "Hospitals Management",
				y: 16.92,
				drilldown: "Hospitals Management"
			}]
		}],
		drilldown: {
			series: [{
