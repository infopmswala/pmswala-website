    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">List Var Section</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3" action="<?=base_url();?>auth/is_session/var_section/" method="GET"
                        ...
                        <?php echo form_close(); ?>
                    <div class="ms-auto"><a href="<?=base_url()?>auth/is_session/var_section/add/"
                ...
                <div class="table-responsive">
                  ...
                  ?> <tr>
                                   ...
                                   <!-- <td><?= $row->sub_title?> </td> -->
                                    ...
                                    <td>
                                       <form method="post"
                                           action="<?=site_url('/auth/is_session/var_section/showpay');?>">
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="<?=base_url()?>auth/is_session/var_section/edit?jwt_token=<?php echo encrypt_decrypt($row->id, 'encrypt')?>"
...
<script>
  ...
  function validate(id, category) {
    swal({
      ...
      $(location).attr('href', '<?php echo base_url()?>auth/is_session/var_section/delete/' +id);
    });
  }
</script>