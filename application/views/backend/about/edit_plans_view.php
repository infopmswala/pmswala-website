<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Edit Plans</div>
            <div class="ps-3">
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">Edit Plans</h5>
                        </div>
                        <hr>
                        <form id="myform" method="post" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" value="<?=$tbl_plans[0]->title?>"
                                 ...
                                 <div class="col-md-12">
                                    <label for="inputFirstName" class="form-label"> Description</label>
                                       <textarea type="text" name="description" id="editor" class="form-control summernote"
                                        required /><?=$tbl_plans[0]->description?></textarea>
                              ...
                              <div class="col-md-6">
                                    <label for="inputFirstName" class="form-label">Image</label>
                                    <img src="<?=base_url()?><?=$tbl_plans[0]->image;?>" alt="Avatar" style="width:136px;border-radius: 50%;height: 83px;">
                                </div>
                                ...
                                <div class="form-group mt-5">
                                    ...
                                    <a onclick="window.location='<?=base_url()?>auth/is_session/about/plans';"
