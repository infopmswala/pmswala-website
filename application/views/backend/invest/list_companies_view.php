    ...
    <div class="page-content">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3" action="<?=base_url();?>auth/is_session/invest/companies" method="GET"
                        ...
                        <?php echo form_close(); ?>
                    <div class="ms-auto"><a href="<?=base_url()?>auth/is_session/invest/add_companies/"
                ...
                <div class="table-responsive">
                  ...
                  foreach($tbl_companies as $key =>$row)
                  {
                  ?> <tr>
                                    <td><?= $start; ?></td>
                                    <td><?= $row->title?> </td>
                                    ...
                                    <td>
                                       <form method="post"
                                           action="<?=site_url('/auth/is_session/invest/showpay_companies');?>">
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="<?=base_url()?>auth/is_session/invest/edit_companies?jwt_token=<?php echo encrypt_decrypt($row->id, 'encrypt')?>"
...
<script>
  ...
  function validate(id, category) {
    swal({
      ...
      $(location).attr('href', '<?php echo base_url()?>auth/is_session/invest/delete_companies/' +id);
    });
  }
</script>