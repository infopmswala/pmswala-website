                        ...
                        <form id="myform" method="post" method="post" enctype="multipart/form-data">
                            <div class="row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" value="<?=$tbl_product_category[0]->title?>"
                                        name="title" id="title" class="form-control" required />
                                </div>
                                 <div class="col-md-6">
                                    <label for="inputFirstName" class="form-label">Short Description</label>
                                    <input type="text" value="<?=$tbl_product_category[0]->short_description?>"
                              ...
                              <div class="col-md-6">
                                    <label for="inputFirstName" class="form-label">Image</label>
                                    <img src="<?=base_url()?><?=$tbl_product_category[0]->image;?>" alt="Avatar" style="width:136px;border-radius: 50%;height: 83px;">
                                </div>
