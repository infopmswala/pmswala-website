                    ...
                    <div class="card-body p-5">
                        ...
                        <form class="row g-3" method="post" enctype="multipart/form-data">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="counter_icon" required>
                            </div>
                            <div class="col-md-6">
                                <label for="inputFirstName" class="form-label">Counter Timer</label>
                                <input type="text" class="form-control" name="counter_timer" required>
                            </div>
                            <div class="col-md-6">
                                <label for="inputFirstName" class="form-label">Counter Operator</label>
                                <input type="text" class="form-control" name="counter_operator" required>
                            </div>
                            <div class="col-md-6">
                                <label for="inputFirstName" class="form-label">Counter Title</label>
                                <input type="text" class="form-control" name="counter_title" required>
                            </div>
                            <div class="col-12">
                                <button type="submit" name="submit" value="td_count_statistics" class="btn btn-primary px-5">Submit</button>
