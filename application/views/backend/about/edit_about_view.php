<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Edit Road Map</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt bx-color"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Edit Road Map</li>
                    </ol>
                </nav>
            </div>
                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">Edit Road Map</h5>
                        </div>
                        <hr>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                   <label for="inputFirstName" class="form-label"> Title</label>
                                    <input type="text" value="<?=$tbl_about[0]->title?>"
                                  ...
                                  <div class="col-md-12">
                                    ...
                                    <textarea type="text" name="description" id="editor" class="form-control summernote"
                                        required /><?=$tbl_about[0]->description?></textarea>
                                </div>
