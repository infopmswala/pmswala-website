                    ...
                    <div class="card-body p-5">
                        ...
                        <form class="row g-3" method="post" enctype="multipart/form-data">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="category" id="inputFirstName" required>
                            </div>

                            <div class="col-md-6">
                                <label for="inputFirstName" class="form-label">Category Slug</label>
                                <input type="text" class="form-control" name="category_slug" id="inputFirstName"
                                    required>
                            </div>
                            <div class="col-md-6">
                                <label for="inputFirstName" class="form-label">Category Icon</label>
                                <input type="text" class="form-control" name="category_icon" id="inputFirstName"
                                    required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <button type="submit" name="submit" value="category"
