    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">List Investment</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3" action="<?=base_url();?>auth/is_session/invest/investment" method="GET"
                        ...
                        <?php echo form_close(); ?>
                    <div class="ms-auto"><a href="<?=base_url()?>auth/is_session/invest/add_investment/"
                ...
                <div class="table-responsive">
                    <table class="table mb-0">
                      ...
                      <tbody>
                                ...
                                <?php 
                                if(!empty($tbl_investment)){
                  foreach($tbl_investment as $key =>$row)
                  {
                  ?> <tr>
                                    <td><?= $start; ?></td>
                                    <td><?= $row->title?> </td>
                                    ...
                                    <td>
                                       <form method="post"
                                           action="<?=site_url('/auth/is_session/invest/showpay_investment');?>">
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="<?=base_url()?>auth/is_session/invest/edit_investment?jwt_token=<?php echo encrypt_decrypt($row->id, 'encrypt')?>"
...
<script>
  ...
  function validate(id, category) {
    swal({
      ...
      $(location).attr('href', '<?php echo base_url()?>auth/is_session/invest/delete_investment/' +id);
    });
  }
</script>