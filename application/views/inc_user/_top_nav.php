                    ...
                    <ul class="nav-elements d-flex align-items-center list-unstyled m-0 p-0">
                        <li class="nav-item nav-author">
                            <a href="#" class="nav-toggler" data-bs-toggle="dropdown" aria-expanded="false">
                                <?php if(!empty($td_users['image']) && $td_users['image'] != '' && $td_users['image'] != null){ ?>
                                <img src="<?=base_url()?><?=$td_users['image']?>" alt="img" width="54" class="rounded-2" style="height: 60px;">
                                <?php }else{ ?>
                                <img src="<?=base_url()?>uploads/profile/dummy.png" alt="img" width="54" class="rounded-2" style="height: 60px;">
                                <?php } ?>
                                <div class="nav-toggler-content">
                                    <h6 class="mb-0"><?=$td_users['name']?></h6>
                                    <div class="ff-heading fs-14 fw-normal text-gray">Investor</div>
                                </div>
                            </a>
                        </li>
                    </ul>
            ...
            <div class="logo">
                <a href="" class="d-flex align-items-center gap-3 flex-shrink-0">
                    ...
                    <!--<div class="position-relative flex-shrink-0">
                        <img src="assets/img/logobg.png" alt="" class="logo-text">
                ...
                <div class="d-flex align-items-center justify-content-end flex-shrink-0">
                    <ul class="nav-elements d-flex align-items-center list-unstyled m-0 p-0">
                        ...
                        <li class="nav-item nav-author px-3">
                            <a href="#" class="nav-toggler" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="<?=base_url()?>assets/user/assets/img/svg/icon-user.png" alt="img" width="40" class="rounded-2">
                                <div class="nav-toggler-content">
                                ...
                                <div class="dropdown-wrapper">
                                    <div class="card mb-0">
                                        <div class="card-header p-3 text-center">
                                            <img src="<?=base_url()?>assets/user/assets/img/svg/icon-user.png" alt="img" width="60"
