...
class Products extends My_Controller {
	...
	public function edit(){
        ...
        $this->data['_view_'] = 'backend/products/edit_products_view';
    ...
    public function products_add(){
		if($_POST){
			if(!empty($_POST["submit"]) == "td_modules"){
                ...
                redirect(base_url() . "auth/is_session/products/products_list/");
			   }
		}  
		$this->data = array(
		...
		$where = array("status" => "1");
        $this->data["td_settings"] = $this->Main_model->get_data($where, "td_settings");
        $this->data['_view_'] = 'backend/products/add_products_view';
        $this->load->view('_backend_', $this->data);
	}
	public function products_list(){
        ...
        $pagination = $this->paginate(base_url() . 'auth/is_session/products/products_list/', $this->Get_paginated_model->get_paginated_modules_count(),10);
		...
		$where = array("status" => "1");
        $this->data["td_settings"] = $this->Main_model->get_data($where, "td_settings");
        $this->data['_view_'] = 'backend/products/list_products_view';
        $this->load->view('_backend_', $this->data);
    }
