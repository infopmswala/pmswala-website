    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">List Price List</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3" action="<?=base_url();?>auth/is_session/pricelist/list_price_list/" method="GET"
                        ...
                        <div class="col-md-3">
                            ...
                            <select class="form-control" name="pricelist" value="<?php echo html_escape($this->input->get('pricelist', true)); ?>">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="text" class="form-control" name="q"
                                ...
                                placeholder="Search Price List" id="inputFirstName">
                        </div>
                        <div class="col-md-3">
                            <label for="inputFirstName" class="form-label">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
                        ...
                        <?php echo form_close(); ?>
                    <div class="ms-auto"><a href="<?=base_url()?>auth/is_session/pricelist/add_price_list/"
                ...
                <div class="table-responsive">
                  ...
                  foreach($td_price_list as $key =>$row)
                  {
                  ?>
                                <td>
                                ...
                                <td><?= $row->mrpl?> </td>
                                <td><?= $row->iocl?> </td>
                                <td><?= $row->petrobazaar?> </td>
                                
                                <td>
                                    <form method="post"
                                        action="<?=site_url('/auth/is_session/pricelist/list_price_list/showpay');?>">
                                ...
                                <td>
                                    <div class="d-flex order-actions">
                                        <a href="<?=base_url()?>auth/is_session/pricelist/edit_price_list/index?jwt_token=<?php echo encrypt_decrypt($row->id, 'encrypt')?>"
                                            class=""><i class='bx bxs-edit' style="font-size: 25px;color: #008000;"></i></a>
                                        <a href="#" onclick="validate('<?php echo $row->id;?>','<?php echo $row->category_price_list;?>')" class="ms-3" style="font-size: 25px;color: #ef0716;"><i class='bx bxs-trash'></i></a>
                                    </div>
                                </td>
                            </tr>
                            <?php
              ...
              ?>
              <?php }else{ ?>
                <td colspan="12" style="text-align: center;color: red;font-size: 19px;">No Record Found</td>
...
<script>
  ...
  function validate(id, title) {
    swal({
      ...
      $(location).attr('href', '<?php echo base_url()?>auth/is_session/pricelist/list_price_list/delete_price_list/' +id);
    });
  }
</script>