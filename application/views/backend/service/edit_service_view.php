            ...
            <div class="col">
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        ...
                        <hr>
                        <form class="row g-3" action="<?=base_url()?>auth/is_session/service/edit/<?=$td_modules['module_id']?>/?jwt_token=<?php echo encrypt_decrypt($td_services['id'], 'encrypt')?>/" method="post" enctype="multipart/form-data">
                            <div class="col-md-6">
                                <label for="inputFirstName" class="form-label"><?=$td_modules['module_name']?> Title</label>
                                <input type="text" class="form-control" name="service_title" value="<?=$td_services['service_title'];?>" required>
                            </div>
                            <div class="col-md-6">
                                <label for="inputFirstName" class="form-label"> Title Slug</label>
                                <input type="text" class="form-control" name="service_slug" value="<?=$td_services['service_slug'];?>" required>
                            </div>
                            <?php 
                             $module_id = array('5002');
                            if(in_array($this->uri->segment(5),$module_id)){ ?>
                            <div class="col-md-12">
                                <label class="form-label">Short Description</label>
                                <textarea class="form-control" rows="3" cols="80"
                                    name="service_short_description"><?=$td_services['service_short_description'];?></textarea>
                                   
                            </div>
                            
                            <div class="col-md-6">
                                <label class="form-label">Short Icon</label>
                                <input type="file" class="form-control"  name="service_icon" value="">
                            </div>
                             <div class="col-md-6">
                                <label for="inputFirstName" class="form-label"><?=$td_modules['module_name']?> Image</label>
                                <div class="upload-btn-wrapper">
                                <img src="<?=base_url()?><?=$td_services['service_icon'];?>" alt="Avatar" style="width:136px;border-radius: 50%;height: 83px;">
                                </div>
                            </div>
                            <?php }else{ ?>
                            <div class="col-md-12">
                            ...
                            <!--        name="service_description"><?=$td_services['service_description'];?></textarea>-->
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="col-md-6">
                                <label for="inputFirstName" class="form-label"><?=$td_modules['module_name']?> Image</label>
                                <div class="upload-btn-wrapper">
                                <img src="<?=base_url()?><?=$td_services['service_image'];?>" alt="Avatar" style="width:136px;border-radius: 50%;height: 83px;">
                                </div>
                            </div>
                             ...
                             <div class="col-md-6">
                                ...
                                <div class="upload-btn-wrapper">
                                    <input type="file" name="service_banner_image" id="service_banner_image">
                                </div>
                            </div>
                              <div class="col-md-6">
                                <label for="inputFirstName" class="form-label"><?=$td_modules['module_name']?> Image</label>
                                <div class="upload-btn-wrapper">
                                <img src="<?=base_url()?><?=$td_services['service_banner_image'];?>" alt="Avatar" style="width:136px;border-radius: 50%;height: 83px;">
                                </div>
                            </div>
                            
                            <div class="col-md-6">
                                <label for="inputFirstName" class="form-label"> Meta Title </label>
                                <input type="text" class="form-control" value="<?=$td_services['meta_title'];?>" name="meta_title" required>
                            </div>
                            <div class="col-md-6">
                                ...
                                <textarea type="text" name="meta_tag_keywords" id="meta_tag_keywords"
                                    class="form-control" placeholder="Enter Meta Keyword" required /><?=$td_services['meta_tag_keywords'];?></textarea>
                            </div>
                            <div class="col-md-6">
                                ...
                                <textarea type="text" name="meta_tag_description" id="meta_tag_description"
                                    class="form-control" placeholder="Enter Meta Description" required /><?=$td_services['meta_tag_description'];?></textarea>
                            </div>
                            
                            <div class="col-12">
                                <button type="submit" name="update" value="service_edit"
