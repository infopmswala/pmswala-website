                ...
                <div class="card border-top border-0 border-4 border-primary">
                    <div class="card-body p-5">
                        <div class="card-title d-flex align-items-center">
                            ...
                            <h5 class="mb-0 text-primary">Add social</h5>
                        </div>
                        <hr>
                        <form class="row g-3" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" name="code" id="inputFirstName" required>
                            </div>
                            <div class="col-md-6">
                                <label for="inputFirstName" class="form-label">Social Link</label>
                                <input type="text" class="form-control" name="link" id="inputFirstName" required>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <button type="submit" name="submit" value="social"
