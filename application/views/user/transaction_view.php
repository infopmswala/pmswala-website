                ...
                <div class="inner-contents">
                    <div class="page-header align-items-center mr-bottom-50">
                        <div class="text-center m-auto">
                            <h4 class="bg-lightgreen p-3 fw-semibold">Transactions</h4>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12 table-responsive">
                            <table class="table text-nowrap">
                                ...
                                <tbody>
                                    <?php foreach($td_payment_transactions as $key => $val){ ?>
                                    <tr class="border-bottom w-50 border-gray border-opacity-50">
                    ...
                    <!--<div class="rounded-2 p-3">
                        ...
                        <?php foreach($td_payment_transactions as $key => $val){ ?>
                            <div class="row">
                                ...
                                <div class="col-6 col-md-3">
                                    <p class="fs-14"><?=$val['portfolio_name'];?></p>
                                </div>
                                <div class="col-6 col-md-2">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="p-3 d-flex justify-content-end text-end">
                                <h5 class="me-4">Total Deposit:
                                <?php if(!empty($td_amount_payment_transactions['amount'])){ ?>
                                <span class="fw-semibold ms-5 me-2">₹ <?=numberFormat($td_amount_payment_transactions['amount']) ?? 0;?>/-</span></h5>
                                <?php }else{ ?>
                                <span class="fw-semibold ms-5 me-2">₹ <?=numberFormat($td_amount_payment_transactions['amount']);?>/-</span></h5>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
