    ...
    <div class="page-content">
            ...
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">List Careers</li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form class="row g-3" action="<?=base_url();?>auth/is_session/careers/list_careers/" method="GET"
                        ...
                        <?php echo form_close(); ?>
                    <div class="ms-auto"><a href="<?=base_url()?>auth/is_session/careers/add_careers/"
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="tablelist">
                        ...
                        <tbody>
                            ...
                            <?php 
                            if(!empty($td_careers)){
                  foreach(array_reverse($td_careers) as $key =>$row)
                  {
                  ?><tr id="sortable">
                                <td>
                                ...
                                <td>
                                    <form method="post"
                                        action="<?=site_url('/auth/is_session/careers/list_careers/showpay');?>">
                                ...
                                <td>
                                    <div class="d-flex order-actions">
                                        <a href="<?=base_url()?>auth/is_session/careers/edit_careers/index?jwt_token=<?php echo encrypt_decrypt($row->id, 'encrypt')?>"
                                            class=""><i class='bx bxs-edit' style="font-size: 25px;color: #008000;"></i></a>
                                        <a href="#" onclick="validate('<?php echo $row->id;?>','<?php echo $row->job_title;?>')" class="ms-3"><i class='bx bxs-trash' style="font-size: 25px;color: #ef0716;"></i></a>
                                    </div>
                                </td>
                            </tr>
                            <?php
